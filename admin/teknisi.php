...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      ...
      <div class="col-sm-1">
        <a href="?hal=teknisi_olah" style="float: right;" class="btn btn-block bg-gradient-primary btn-sm">Tambah</a>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
              ...
              if ($num_result > 0 ) { 
                ...
                while ($data=mysqli_fetch_assoc($result)) {
                  ...
                  <td width="15%">
                    ...
                    <a href="?hal=teknisi_olah&id=<?=$idteknisi; ?>" 
                      class="btn btn-icon btn-primary" title="Edit Data"><i class="fa fa-edit"></i> </a>

                      <a class="btn btn-danger" title="Hapus Data" href="teknisi_proses.php?hapus=<?=$idteknisi;?>" 
