        ...
        <div class="card-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              $query="SELECT * from tb_servis join tb_teknisi using(idteknisi) join tb_pelanggan using(idpelanggan) where idteknisi='$idteknisi' and (status='masuk' or status='pengerjaan')";
