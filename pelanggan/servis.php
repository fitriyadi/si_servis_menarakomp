...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Data Servis</h1>
      </div><!-- /.col -->
      <div class="col-sm-5">
      </div>
    </div><!-- /.row -->
        ...
        <div class="card-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            $idpelanggan=$_SESSION['pelanggan'];
              $query="SELECT * from tb_servis join tb_teknisi using(idteknisi) join tb_pelanggan using(idpelanggan) where tb_servis.idpelanggan='$idpelanggan'";
